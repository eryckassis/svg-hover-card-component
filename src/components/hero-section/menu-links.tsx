      ...
      <nav ref={navRef} className="flex flex-col gap-2">
        {LINKS.map((link) => (
          <a
            ...
            href={link.href}
            data-menu-link
            className="group relative flex items-center justify-between rounded-full pl-2 pr-6 py-2 font-aeonik text-[1.625em] font-normal tracking-wide text-neutral-900 uppercase"
          >
            {}
            <span
              data-link-bg
