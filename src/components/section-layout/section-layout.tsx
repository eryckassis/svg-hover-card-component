  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 min-[1000px]:grid-cols-2 xl:grid-cols-[0.8fr_1.2fr] gap-10 lg:gap-14 xl:gap-20">
        <h2
          className={`relative mt-0 mb-0 ml-0 2xl:ml-16 min-[2200px]:94ml-80 max-w-[18ch] text-[clamp(1.5rem,2.5vw,3.2em)] font-normal leading-[1.2] tracking-[-0.01em] ${headlineColor}`}
        >
          {headline}
        </h2>
        <FeatureList
